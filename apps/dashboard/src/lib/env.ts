...
export const dashboardEnv = {
  orchestratorUrl: readEnv("NEXT_PUBLIC_ORCHESTRATOR_URL", "http://localhost:8000"),
  supabaseUrl: readEnv("NEXT_PUBLIC_SUPABASE_URL", "https://example.supabase.co"),
  supabaseAnonKey: readEnv("NEXT_PUBLIC_SUPABASE_ANON_KEY", "missing-supabase-anon-key"),
};
